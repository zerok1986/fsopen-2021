...
describe('total likes', () => {
  ...
  test('when list has more than one blog, sums the likes of all of them', () => {
...
describe('author with more blogs', () => {
  test('returns the author with more blogs and its number', () => {
...
describe('author with more likes', () => {
  test('returns the author with more likes and its number', () => {
